...
RUN apt-get update && apt-get install --fix-missing -y git emacs curl iputils-ping python3-dev python3-pip build-essential supervisor nginx libpq-dev libcurl4-openssl-dev uwsgi-plugin-python3 supervisor 
