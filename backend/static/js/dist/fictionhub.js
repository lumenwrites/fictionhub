...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
				...
				if (_jsCookie2.default.get('subscription_box_closed') == null && $.query.get('notification') != "subscribed") {
				...
				if (notification == "subscribed") {
							$(".alert").show();
							console.log("Subscription box closed!");
							_jsCookie2.default.set('subscription_box_closed', 'yes', { expires: 500 });
				...
				if (source) {
							_jsCookie2.default.set('src', source, { expires: 10 });
				} else {
							/* If there's no src in url, try getting source from cookies */
							source = _jsCookie2.default.get('src');
				}
				if (source) {
							$("#src").val(source);
